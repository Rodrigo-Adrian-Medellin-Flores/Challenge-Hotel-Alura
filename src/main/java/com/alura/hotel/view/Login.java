...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(getClass().getResource("/com/alura/hotel/imagenes/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(getClass().getResource("/com/alura/hotel/imagenes/lOGO-50PX.png")));
