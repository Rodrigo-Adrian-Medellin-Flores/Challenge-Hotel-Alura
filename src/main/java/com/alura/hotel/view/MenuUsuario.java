...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(getClass().getResource("/com/alura/hotel/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(getClass().getResource("/com/alura/hotel/imagenes/reservado.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(getClass().getResource("/com/alura/hotel/imagenes/pessoas.png")));
