...
public class Exito extends JDialog {
	...
	/*public static void main(String[] args) {
		try {
			Exito dialog = new Exito(new JFrame());
	...
	public Exito(JFrame frame) {
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(getClass().getResource("/com/alura/hotel/imagenes/Ha-100px.png")));
			lblNewLabel.setBounds(123, 11, 100, 100);
			contentPanel.add(lblNewLabel);
		}
		{
			JLabel lblNewLabel_1 = new JLabel("Su reservación fue registrada con éxito");
